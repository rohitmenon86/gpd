#include <gpd/grasp_detector_ros.h>


GraspDetectorRos::GraspDetectorRos(ros::NodeHandle& node)
{
  cloud_camera_ = NULL;
...
bool GraspDetectorRos::detectGraspsInMsg(const sensor_msgs::PointCloud2& msg, gpd::GraspConfigList& gpd_grasps)
{
...
gpd::GraspConfigList GraspDetectorRos::createGraspListMsg(const std::vector<Grasp>& hands)
{
...
gpd::GraspConfig GraspDetectorRos::convertToGraspMsg(const Grasp& hand)
{
  gpd::GraspConfig msg;
